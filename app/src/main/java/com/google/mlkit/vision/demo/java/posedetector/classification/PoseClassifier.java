...
import com.google.mlkit.vision.demo.java.posedetector.PartOfBodysAngles;
...
public class PoseClassifier {
  ...
  public static PartOfBodysAngles getAngles(Pose pose) {
    double dedoantebrazohombro = getAngle(pose.getPoseLandmark(PoseLandmark.LEFT_THUMB),
                                    pose.getPoseLandmark(PoseLandmark.LEFT_ELBOW),
                                    pose.getPoseLandmark(PoseLandmark.LEFT_SHOULDER));

    PartOfBodysAngles nuevo = new PartOfBodysAngles();
    nuevo.angulo= dedoantebrazohombro;
    nuevo.parte="dedoantebrazohombro";
    return  nuevo;
